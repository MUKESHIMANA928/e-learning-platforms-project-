...
(4, 17, 6, '2025-06-10 09:43:09', 0),
(5, 17, 7, '2025-06-10 09:43:27', 0);
...
(1, 'Networking', 'Making RJ-45 cables and other networking cables', 0, 23),
(6, 'Programing with clients server', 'Eugene is the creator of this module. ', 0, 23),
(7, 'Networking and its contents', 'made by the administrator ', 0, 23),
(10, 'RMT ', '15creadit', 1, 23);
...
(1, 1, 'pdf', 'the basics of networking cables', 'Let\'s know how to create these cables', 'uploads\\contentFile-1748955712112.pdf', 'ETHERNET CABLE.pdf', '2025-06-03 13:01:52', 1),
(7, 1, 'video', 'Wireless technology', 'wireless handover', '/uploads/contentFile-1749396037376.mp4', 'this.mp4', '2025-06-08 15:20:37', 0),
...
(2, 2, 'Briefly, explain the importance of networking.', 'short_answer', 0),
(3, 2, 'What are the types of network cable?', 'short_answer', 1),
(4, 3, 'what is progrmming?', 'short_answer', 0);
...
(2, 7, 'bit 3 first quize', 'do all questions', 26, 58, '2025-06-10 07:22:53', '2025-06-10 07:22:53'),
(3, 6, 'bit 3', '10 credits', 6, 35, '2025-06-11 10:18:43', '2025-06-11 10:18:43');
...
(2, 2, 2, 17, NULL, NULL, 0),
(3, 3, 2, 17, NULL, NULL, 0);
...
(2, 2, 17, 0.00, 0, '2025-06-10 07:48:39');
...
(25, 'emmy', 'izere', 'emmy@', 'izere@gmail.com', '$2b$10$Nz0t71IUvDXV.U1ncZjPT.8SGGHRY/nMqcYWR0D8RcocqeijHAzCu', 'lecturer', 1);
